...
},{"eve":"node_modules/eve/eve.js"}],"tracks/tracks.const.ts":[function(require,module,exports) {
"use strict";
...
var Curve = function () {
  ...
  Curve.prototype.moveAnchor = function (point, dx, dy, x, y, event) {
    var currentArc = this.arcs[point.arcID];
    var prevArc = this.arcs[point.arcID - 1];
  ...
  Curve.prototype.addAnchor = function (arc, x, y) {
    ...
    for (var i = 0; i < this.arcs.length - 1; i++) {
      var item = this.arcs[i];
      item.arcID = i;
  ...
  Curve.prototype.deleteAnchor = function () {};

  Curve.prototype.changeArcColor = function () {};

  return Curve;
}();

exports.Curve = Curve;
},{"../tracks/tracks.const":"tracks/tracks.const.ts","uuid":"node_modules/uuid/dist/esm-browser/index.js"}],"curve/view.ts":[function(require,module,exports) {
"use strict";
...
},{"snapsvg":"node_modules/snapsvg/dist/snap.svg.js"}],"curve/controller.ts":[function(require,module,exports) {
"use strict";
...
},{"./model":"curve/model.ts","./view":"curve/view.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
controller.draw();
},{"snapsvg":"node_modules/snapsvg/dist/snap.svg.js","./curve/controller":"curve/controller.ts"}],"../../AppData/Roaming/nvm/v14.17.6/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
